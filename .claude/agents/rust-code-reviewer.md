...
description: "Reviews Rust code changes using the rust-review skill in an isolated context to ensure an unbiased, independent evaluation."
model: sonnet
---
...
Use the rust-review skill to identify issues in Rust code.
